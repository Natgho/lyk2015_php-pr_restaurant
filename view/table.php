    ...
    <div class="col-sm-6">
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="pull-right"><?= $urun['product_price'] ?> TL
                                    <a href="orderTasks.php?task=delete&orderProductId=<?= $urun['id'] ?>&tableId=<?= $table['id'] ?>"
        ...
        <?php if ($table["status"] == "1"): ?>
            ...
            <?php if (count($orderedItems) > 0): ?>
                ...
                <br>
                <br>
                <a href="orderTasks.php?task=finish&tableId=<?= $table['id'] ?>" class="btn btn-success btn-block">Hesabı
                    Kapat</a>
            <?php endif; ?>
        <?php endif; ?>
